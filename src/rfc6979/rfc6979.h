...
inline void secp256k1_sha256_write(secp256k1_sha256_t *hash,
...
inline void secp256k1_sha256_finalize(secp256k1_sha256_t *hash,
                                      unsigned char *out32) {
...
inline void secp256k1_hmac_sha256_initialize(secp256k1_hmac_sha256_t *hash,
...
inline void secp256k1_hmac_sha256_write(secp256k1_hmac_sha256_t *hash,
                                        const unsigned char *data,
                                        size_t size) {
  secp256k1_sha256_write(&hash->inner, data, size);
}

inline void secp256k1_hmac_sha256_finalize(secp256k1_hmac_sha256_t *hash,
                                           unsigned char *out32) {
...
inline void secp256k1_rfc6979_hmac_sha256_initialize(
    secp256k1_rfc6979_hmac_sha256_t *rng, const unsigned char *key,
    size_t keylen) {
...
inline void secp256k1_rfc6979_hmac_sha256_generate(
    secp256k1_rfc6979_hmac_sha256_t *rng, unsigned char *out, size_t outlen) {
  /* RFC6979 3.2.h. */
  static const unsigned char zero[1] = {0x00};
  if (rng->retry != 0) {
    secp256k1_hmac_sha256_t hmac;
...
inline void secp256k1_rfc6979_hmac_sha256_finalize(
...
inline int nonce_function_rfc6979(unsigned char *nonce32,
