...
#ifndef IDENTITIES_ADDRESS_HPP
#define IDENTITIES_ADDRESS_HPP
...
class Address {
 public:
  ...
  static Address fromPublicKey(const uint8_t* publicKeyBytes, uint8_t version);
  static Address fromPrivateKey(const uint8_t* privateKeyBytes, uint8_t version);
