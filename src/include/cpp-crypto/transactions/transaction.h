...
class Transaction {
 public:
  ...
  std::vector<uint8_t> toBytes(bool skipSignature = true,
                               bool skipSecondSignature = true) const;
 ...
 private:
  bool internalVerify(std::string publicKey, std::vector<uint8_t> bytes,
