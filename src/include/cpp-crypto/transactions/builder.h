...
class Builder {
 public:
  static Transaction buildTransfer(std::string recipientId, uint64_t amount,
  ...
  static Transaction buildDelegateRegistration(
      std::string username, std::string passphrase,
      std::string secondPassphrase = "");
  static Transaction buildVote(std::vector<std::string> votes,
                               std::string passphrase,
                               std::string secondPassphrase = "");
 ...
 private:
  ...
  static Transaction sign(Transaction transaction, std::string passphrase,
                          std::string secondPassphrase = "");
