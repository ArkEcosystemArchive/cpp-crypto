...
class Slot {
 public:
  static uint64_t epoch_time(Crypto::Networks::AbstractNetwork network) {
    return epoch_time(now(), network);
  }
  static uint64_t epoch_time(uint64_t time,
                             Crypto::Networks::AbstractNetwork network);
  ...
  static uint64_t time(Crypto::Networks::AbstractNetwork network) {
    return Slot::time(now(), network);
  }
  static uint64_t time(uint64_t time,
                       Crypto::Networks::AbstractNetwork network);
  static uint64_t real_time(Crypto::Networks::AbstractNetwork network) {
    return real_time(Slot::time(network), network);
  }
  static uint64_t real_time(uint64_t epoch_time,
                            Crypto::Networks::AbstractNetwork network);
