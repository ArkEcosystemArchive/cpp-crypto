...
const uint8_t testPublicKeyBytes[33] = {
    2,   159, 223, 65,  167, 214, 157, 142, 252, 123, 35,
    108, 33,  185, 80,  154, 35,  216, 98,  234, 78,  216,
    177, 58,  86,  227, 30,  238, 88,  219, 253, 151, 180};
}  // namespace
...
TEST(identities, publickey_validate_string) {
  ASSERT_TRUE(PublicKey::validate(
      "029fdf41a7d69d8efc7b236c21b9509a23d862ea4ed8b13a56e31eee58dbfd97b4"));
}
