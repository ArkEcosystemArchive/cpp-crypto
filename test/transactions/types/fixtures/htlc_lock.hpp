...
static constexpr const uint8_t TYPE_8_EXPIRATION_TYPE       = 1ULL;
static constexpr const uint32_t TYPE_8_EXPIRATION_VALUE     = 81242895UL;
...
static constexpr const char* TYPE_8_EXPIRATION_VALUE_STRING     = "81242895";
