...
arduino-cli lib install "avr_stl@1.2.1"
...
arduino-cli compile --output temp.bin -v -b arduino:avr:uno ~/Arduino/libraries/cpp-crypto/examples/arduino/ATMEGA328P/ATMEGA328P.ino --debug
